	...
	<div class="container" id="container-preregister">
		...
		<div class="panel panel-default" id="panel-default-form">
			...
			<div class="panel-heading" id="panel-heading-preregister">
				Please complete the fields below to enroll for any of our product(s). All Fields are required (<i class="fa fa-asterisk" aria-hidden="true" style="font-size:10px; color:red"></i>).
			</div>
				...
				<div class="panel panel-default" style="background:#fff; border-radius:0;  border:0">
					...
					<div class="panel-body">
						...
						<label class="radio-inline">
							<input type="radio" name="investment_type" value="Binary option" checked="checked">Binary option
						</label>
						<label class="radio-inline">
							<input type="radio" name="investment_type" value="Cryptocurrency">Cryptocurrency
						</label>
						<label class="radio-inline">
							<input type="radio" name="investment_type" value="Swissgolden">Swissgolden
						</label>
				...
				<div class="panel panel-default" style="background:#Fff; border-radius:0;  box-shadow: 0px 3px 3px 0px rgba(0,0,0,0.2); border:0; ">
					...
					<div class="panel-body">
						...
						<div class="form-group">
								...
								<input type="text" class="form-control form-control_ datepicker" id="email" name="dob" value="<?php echo $_POST['dob'] ; ?>" required readonly>
						</div>
						</div>
